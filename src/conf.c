...
char *vless_uuid = NULL;
bool vless_reality_enabled = false;
char *vless_reality_dest = NULL;
int vless_reality_dest_port = 443;
char *vless_reality_server_name = NULL;
char *vless_reality_public_key = NULL;
char *vless_reality_private_key = NULL;
