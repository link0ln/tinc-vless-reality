...
connection_t *new_connection(void) {
	connection_t *c = xzalloc(sizeof(connection_t));

	/* VLESS contexts will be initialized on demand when needed */
	c->vless = NULL;
	c->reality = NULL;
...
void free_connection(connection_t *c) {
	...
	/* Free VLESS and Reality contexts */
	if(c->vless) {
