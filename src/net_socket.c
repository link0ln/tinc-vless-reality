...
static bool vless_accept_connection(connection_t *c) {
	...
	/* Reality TLS handshake is optional - only for external connections
	 * Internal tinc nodes connect directly with VLESS
	 * Reality fallback is triggered on VLESS handshake failure */
